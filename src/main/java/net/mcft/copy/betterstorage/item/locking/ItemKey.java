...
public class ItemKey extends ItemBetterStorage implements IKey {
	...
	*/
	...
	public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
		playerIn.addChatMessage(new ChatComponentText(String.valueOf(worldIn.isRemote)));
		playerIn.addChatMessage(new ChatComponentText(String.valueOf(playerIn.getEntityData())));
