...
public class ChristmasEventHandler {
	...
	private static void getItemsFor2014(List<ItemStack> items, EntityPlayer player) {
		...
		sword.addEnchantment(Enchantment.baneOfArthropods, 5); //baneOfArthropods
		sword.addEnchantment(Enchantment.knockback, 3); //knockback
		...
		chestplate.addEnchantment(Enchantment.protection, 4); //protection
		...
		if (BetterStorageItems.drinkingHelmet != null) {
			...
			drinkingHelmet.addEnchantment(Enchantment.protection, 5); //protection
			drinkingHelmet.addEnchantment(Enchantment.respiration, 3); //respiration
